            ...
            <div class="signin-signup">
                <form method="POST" action="{{ route('login') }}" class="sign-in-form">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" name="email" value="{{ old('email') }}" autocomplete="username" placeholder="Username" required="yes">
                        @error('email')
                    ...
                    <input type="submit" value="INISIAR SESION" class="btn solid">
